...
Latest follow-up: the [three-study pass](followup_session_report.md) adds safe public-input history expressions to the same investigation loop. Memory helps; active acquisition and reliable recognition of incomplete explanations remain open. Reconsideration of hypotheses as new evidence arrives is the next design target, with strong construction and random-acquisition controls. No new-physics, general-discovery or novelty claim.
